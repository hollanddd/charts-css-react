...
/**
 * Represents a new area or line vector
 */
...
/**
 * Represence a the table structure of an area or line chart
 */
export const VectorData: React.FC<VectorDataProps> = ({
  start,
  size,
  value,
  hidable
}) => {
  return <Data start={start} size={size} value={value} hidable={hidable} />
}
